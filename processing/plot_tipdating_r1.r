...
## 1. RF distance ##
d_rf1  <- read.table("tipdating_corr/gkv-r1-vs-mkv/dist_rf.txt",    header=T)
d_rf2  <- read.table("tipdating_corr/gkv-r1-a5-vs-mkv/dist_rf.txt", header=T)
d_rf3  <- read.table("tipdating_corr/gkv-r1-a1-vs-mkv/dist_rf.txt", header=T)
d_rf4  <- read.table("tipdating_corr/gkv-r1-vs-fkv/dist_rf.txt",    header=T)
d_rf5  <- read.table("tipdating_corr/gkv-r1-a5-vs-fkv/dist_rf.txt", header=T)
d_rf6  <- read.table("tipdating_corr/gkv-r1-a1-vs-fkv/dist_rf.txt", header=T)
...
th_estm1 <- read.table("tipdating_corr/gkv-r1-vs-mkv/th_estm.txt")
th_estm2 <- read.table("tipdating_corr/gkv-r1-a5-vs-mkv/th_estm.txt")
th_estm3 <- read.table("tipdating_corr/gkv-r1-a1-vs-mkv/th_estm.txt")
th_estm4 <- read.table("tipdating_corr/gkv-r1-vs-fkv/th_estm.txt")
th_estm5 <- read.table("tipdating_corr/gkv-r1-a5-vs-fkv/th_estm.txt")
th_estm6 <- read.table("tipdating_corr/gkv-r1-a1-vs-fkv/th_estm.txt")
...
## 3. clock rate ##
cl_estm1  <- read.table("tipdating_corr/gkv-r1-vs-mkv/cl_base.txt")
cl_estm2  <- read.table("tipdating_corr/gkv-r1-a5-vs-mkv/cl_base.txt")
cl_estm3  <- read.table("tipdating_corr/gkv-r1-a1-vs-mkv/cl_base.txt")
cl_estm4  <- read.table("tipdating_corr/gkv-r1-vs-fkv/cl_base.txt")
cl_estm5  <- read.table("tipdating_corr/gkv-r1-a5-vs-fkv/cl_base.txt")
cl_estm6  <- read.table("tipdating_corr/gkv-r1-a1-vs-fkv/cl_base.txt")
cl_var1   <- read.table("tipdating_corr/gkv-r1-vs-mkv/cl_var.txt")
cl_var2   <- read.table("tipdating_corr/gkv-r1-a5-vs-mkv/cl_var.txt")
cl_var3   <- read.table("tipdating_corr/gkv-r1-a1-vs-mkv/cl_var.txt")
cl_var4   <- read.table("tipdating_corr/gkv-r1-vs-fkv/cl_var.txt")
cl_var5   <- read.table("tipdating_corr/gkv-r1-a5-vs-fkv/cl_var.txt")
cl_var6   <- read.table("tipdating_corr/gkv-r1-a1-vs-fkv/cl_var.txt")
