...
# missing
cl_m1  <- read.table("tipdating-mis/m2v-vs-m2v/cl_base.txt",     header=F)
cl_m2  <- read.table("tipdating-mis/m2v-vs-f2v/cl_base.txt",     header=F)
cl_m3  <- read.table("tipdating-mis/f2v-a1-vs-m2v/cl_base.txt",  header=F)
cl_m4  <- read.table("tipdating-mis/f2v-a1-vs-f2v/cl_base.txt",  header=F)
cl_m5  <- read.table("tipdating-mis/f2v-v4-vs-m2v/cl_base.txt",  header=F)
cl_m6  <- read.table("tipdating-mis/f2v-v4-vs-f2vg/cl_base.txt", header=F)
cl_m7  <- read.table("tipdating-mis/g4v-a10-vs-m2v/cl_base.txt", header=F)
cl_m8  <- read.table("tipdating-mis/g4v-a10-vs-f2v/cl_base.txt", header=F)
cl_m9  <- read.table("tipdating-mis/g4v-a1-vs-m2v/cl_base.txt",  header=F)
cl_m10 <- read.table("tipdating-mis/g4v-a1-vs-f2v/cl_base.txt",  header=F)
cl_m11 <- read.table("tipdating-mis/g4v-v4-vs-m2v/cl_base.txt",  header=F)
cl_m12 <- read.table("tipdating-mis/g4v-v4-vs-f2vg/cl_base.txt", header=F)
cl_m13 <- read.table("tipdating-mis/g8v-a10-vs-m2v/cl_base.txt", header=F)
cl_m14 <- read.table("tipdating-mis/g8v-a10-vs-f2v/cl_base.txt", header=F)
cl_m15 <- read.table("tipdating-mis/g8v-a1-vs-m2v/cl_base.txt",  header=F)
cl_m16 <- read.table("tipdating-mis/g8v-a1-vs-f2v/cl_base.txt",  header=F)
cl_m17 <- read.table("tipdating-mis/g8v-v4-vs-m2v/cl_base.txt",  header=F)
cl_m18 <- read.table("tipdating-mis/g8v-v4-vs-f2vg/cl_base.txt", header=F)
